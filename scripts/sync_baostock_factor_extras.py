# -*- coding: utf-8 -*-
"""
BaoStock 补齐 factor_data_wide 扩展字段（近三年增量覆盖）。

  python scripts/sync_baostock_factor_extras.py
  python scripts/sync_baostock_factor_extras.py --dry-run
  python scripts/sync_baostock_factor_extras.py --status
  python scripts/sync_baostock_factor_extras.py --max-stocks 50
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="BaoStock 扩展字段同步至 factor_data_wide")
